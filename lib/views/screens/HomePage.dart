...
import 'package:fashion/views/screens/ContactModel.dart';
                  ...
                  ? Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            print(
                                "Delete List Length: ${selectedContacts.length}");
                          },
                        ),
                      ),
                    )
      ...
      onTap: () {
        setState(() {
          ...
          if (contacts[index].isSelected) {
            ...
            selectedContacts.removeWhere((element) => element.name == name);
          }
        });
      },
    );
